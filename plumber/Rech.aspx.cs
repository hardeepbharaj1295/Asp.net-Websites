...
public partial class Rech : System.Web.UI.Page
{
    SqlCommand comm;
    SqlConnection con;
    ...
    {
        comm = new SqlCommand("insert into recharge values(@e,@a,@b,@c,@d)", con);
        comm.Parameters.AddWithValue("@e", DropDownList1.Text);
        ...
        Response.Write("<script>alert('Recharge Succesfull')</script>");
        TextBox1.Text = "";
        TextBox2.Text = "";
        TextBox3.Text = "";
