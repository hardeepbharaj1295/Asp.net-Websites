...
public partial class admin_AddProduct : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
            ...
            comm = new SqlCommand("insert into Products values(@a,@b,@c,@d,@e,@f,@g,@h)", con);
            ...
            comm.Parameters.AddWithValue("@f", Session["id"].ToString());
            comm.Parameters.AddWithValue("@g", Session["userno"].ToString());
            comm.Parameters.AddWithValue("@h", "Pending");
