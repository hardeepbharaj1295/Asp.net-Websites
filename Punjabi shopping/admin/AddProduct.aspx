...
<div class="row">
    ...
    <form id="Form1" class="form-horizontal" runat="server">
            	        ...
            	        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <asp:DropDownList ID="DropDownList1" CssClass="form-control" runat="server">
                                    ...
                                    <asp:ListItem>Punjabi Suits</asp:ListItem>
                                    <asp:ListItem>Punjabi Jutti</asp:ListItem>
                                    <asp:ListItem>Punjabi Kurti</asp:ListItem>
                                </asp:DropDownList>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            DeleteCommand="DELETE FROM [Jewellery] WHERE [id] = @id" 
            InsertCommand="INSERT INTO [Jewellery] ([name], [photo], [type], [price], [description]) VALUES (@name, @photo, @type, @price, @description)" 
            SelectCommand="SELECT * FROM [Jewellery]" 
            UpdateCommand="UPDATE [Jewellery] SET [name] = @name, [photo] = @photo, [type] = @type, [price] = @price, [description] = @description WHERE [id] = @id">
            <DeleteParameters>
