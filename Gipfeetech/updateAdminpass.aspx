<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="updateAdminpass.aspx.cs" Inherits="updateAdminpass" %>
                ...
                <div class="panel-body">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="TextBox1" CssClass="form-control" TextMode="Password" required="required" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <asp:TextBox ID="TextBox3" CssClass="form-control" TextMode="Password" required="required" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
