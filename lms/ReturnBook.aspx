<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="ReturnBook.aspx.cs" Inherits="ReturnBook" %>
        ...
        <asp:GridView ID="GridView1" CssClass="table table-responsive" runat="server" 
            ...
            <Columns>
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM [book_issue] WHERE [id] = @id" 
                    InsertCommand="INSERT INTO [book_issue] ([bookid], [rollno], [issue_date], [return_date], [fine]) VALUES (@bookid, @rollno, @issue_date, @return_date, @fine)" 
                    SelectCommand="SELECT * FROM [book_issue] WHERE (([bookid] = @bookid) AND ([rollno] = @rollno)) ORDER BY [id] DESC" 
                    UpdateCommand="UPDATE [book_issue] SET [bookid] = @bookid, [rollno] = @rollno, [issue_date] = @issue_date, [return_date] = @return_date, [fine] = @fine WHERE [id] = @id">
                    <DeleteParameters>
