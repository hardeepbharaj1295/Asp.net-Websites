...
public partial class ReturnBook : System.Web.UI.Page
{
    ...
    {
        String issue = null;
        cmd = new SqlCommand("select issue_date from book_issue where bookid=@a and rollno=@b",con);
        ...
        cmd = new SqlCommand("update book_issue set return_date=@a,fine=@b where bookid=@c and rollno=@d", con);
