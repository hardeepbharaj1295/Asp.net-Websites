...
public partial class admin_AddCategory : System.Web.UI.Page
{
    ...
    {
        FileUpload1.SaveAs(Server.MapPath("category/") + FileUpload1.FileName.ToString());
        comm = new SqlCommand("insert into category values(@a,@b)", con);
        comm.Parameters.AddWithValue("@a", TextBox1.Text);
        comm.Parameters.AddWithValue("@b", "category/" + FileUpload1.FileName.ToString());
